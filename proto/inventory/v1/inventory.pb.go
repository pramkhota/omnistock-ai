...
func (x *ReserveStockRequest) GetProductSku() string {
	if x != nil {
		return x.ProductSku
	}
	return ""
...
const file_proto_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\"proto/inventory/v1/inventory.proto\x12\finventory.v1\"R\n" +
	"\x13ReserveStockRequest\x12\x1f\n" +
	...
	"\fReserveStock\x12!.inventory.v1.ReserveStockRequest\x1a\".inventory.v1.ReserveStockResponseB!Z\x1fomnistock-ai/proto/inventory/v1b\x06proto3"
